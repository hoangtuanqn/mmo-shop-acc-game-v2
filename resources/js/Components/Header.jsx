...
export default function Header() {
    ...
    return (
        <header className="sticky z-50 mx-4 mt-4 mb-16 bg-white rounded-lg shadow-sm ht-background-blur top-2">
            <div className="flex items-center justify-between py-3 mx-auto container-content">
                {/* Logo */}
                <Link href="/" className="flex items-center gap-2">
                    <img src="/images/logo.png" alt="Logo Website" className="object-contain h-auto w-36" />
                </Link>
