...
export default function ModalPopup() {
    ...
    const handleClose = (e) => {
        ...
        const isClose = e.target.closest('button[name="close"]') || e.target.getAttribute("name") === "close";
        setStatus(!isClose);
    };
            ...
            {status && (
                ...
                >
                    <div className="animate-scaleUp relative top-3 h-fit w-[90%] max-w-[600px] overflow-hidden rounded-lg bg-gradient-to-br from-white to-[#f5f8ff] p-6 shadow-lg">
                        ...
                        <div className="close_popup ht-flex-center flex-col border-t border-gray-200">
