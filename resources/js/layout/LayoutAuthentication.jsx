                        ...
                        <div className="w-full max-w-md">
                            <div className="text-gray-700">
                                <h2 className="text-center text-xl font-semibold text-slate-900 md:text-2xl">
                                    {isPageLogin ? "Đăng Nhập" : "Tạo Tài Khoản"}
                                </h2>
                                <p className="mt-2 text-center text-xs font-semibold text-gray-500 md:text-sm">
                                    {isPageLogin ? "Đăng Nhập Vào" : "Tạo Tài Khoản Trên"} Hệ Thống Của Chúng Tôi
                                </p>
                                {children}
                                ...
                                <p className="mt-6 text-center text-xs leading-5 text-slate-800 uppercase md:text-sm">
                                    {isPageLogin ? "Bạn chưa có tài khoản?" : "Bạn đã có tài khoản?"}
                                    <a href={isPageLogin ? "/register" : "/login"} className="ht-item-achor">
                                        {isPageLogin ? "Tạo Tài Khoản Ngay" : " Đăng Nhập Ngay"}
                                    </a>
                                </p>
                            </div>
                        </div>
