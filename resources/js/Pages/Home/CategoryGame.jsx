...
export default function CategoryGame({ nameCategory, data }) {
    return (
        <div className="mb-20">
            <HeadLine nameCategory={`Danh mục ${nameCategory}`} view={true} url="/" />
                ...
                {data.map((category, key) => (
                    ...
                    >
                        ...
                        <img
                            ...
                            alt={category.name}
                        />
                        <div className="flex-col gap-3 px-2 py-3 text-xs bg-white ht-flex-center md:mt-0 md:p-5 md:text-sm">
                            ...
                            <div className="flex-col gap-2 ht-flex-center text-gray-dark lg:flex-row">
                                <span className="bg-gray-light ht-flex-center w-fit gap-x-2 rounded-full px-1.5 py-2">
                                    <FaCubes />
                                    Còn:
